...
import { bigButton, gameCard, el, iconButton, optionPanels } from './components.js?v=0805b1';
import { iconEl } from './icons.js?v=0805b1';
import { APP_TITLE, APP_ICON, QUESTION_COUNTS, applyIdentity } from '../identity.js?v=0805b1';
import { freqOfMidi, detune } from '../theory.js?v=0805b1';
import { isImageIcon } from './icons.js?v=0805b1';
